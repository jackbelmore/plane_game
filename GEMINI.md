...
- **Assets:** GLTF/GLB for 3D models, OGG for audio.
...
## 📂 Project Structure
- `src/main.rs`: Monolithic entry point containing all components, systems, and game logic.
- `assets/`:
  - `models/`: GLB files for the jet and environment.
  - `sounds/`: OGG audio loops and effects.
  - `fantasy_town/`: Modular assets for procedural villages.
- `.github/`: Contains detailed technical post-mortems and fix documentation (e.g., `AUDIO-FIX-UNRECOGNIZED-FORMAT.md`, `DAMPING-FIX-APPLIED.md`).
